# Water Well (Well Utility Area)

## Purpose

This document defines the family's permanent Water Well and Well Utility Area — the household water and washing zone directly behind the Kitchen.

Landmarks and the Village Master Map require this place. It is a frequently visited domestic landmark connecting kitchen work, gardening, and backyard life.
...
The Water Well is not a public village well.
...
Permanent placement from Village Master Map:

```text
Kitchen → Rear Veranda → Well Utility Area → Backyard
```

Locks:

* Directly behind the Kitchen / Rear Veranda.
* Backyard begins immediately beyond the Well Utility Area (~10 seconds walk).
* Vegetable Garden and Livestock Shelter remain reachable without leaving family property.
* Walking time Family House → Well Utility Area ≈ 30 seconds (per Master Map table).

Never relocate the well to the Front Garden, courtyard centre, or public square.
...
* Large electric pump house as the hero architecture.
