...
The Family House is the primary setting of the Village Stories universe.

It is where the family's daily life unfolds, where traditions are passed from one generation to the next, and where many of the series' most memorable moments take place.

Although the village is rich with many recurring locations, the Family House remains the emotional centre of the entire series.

Every room, pathway, and outdoor space should feel familiar to viewers over time.
...
The producer **does not save house reference images** as generation authority.
For every episode / shot that shows the house, thinnai, yard, or homestead
long-shot, the assistant **must paste the verbal lock below in full words**
into the image/animation prompt package so the producer can tweak that episode.

PNG files under `11_Assets/Location_References/` (if any) are optional archive /
...
### Optional archive paths only (NOT required for generation)
...
Rejected looks (describe in words when QA’ing — do not chase these):

- Cream walls + Mangalore tiles on the Main Family House.
- Compound / perimeter wall around the yard.
- Perfect straight neighbour street grid / bird’s-eye planned colony.

### Long-shot establishing composition (LOCKED — say in words)
...
- Lush coconut palms + banana + extra trees.
- Yard **opens to village green path** — **NO compound / perimeter wall**.
...
### Copy-ready verbal locks (WORDS FIRST — paste every episode)

Producer does not save house PNGs for generation. **Paste the matching block in
words** into each episode’s house / thinnai / yard / long-shot prompt. Tweak
only season, weather, time, and story props for that episode — do not break
LOCKED materials or open-yard rules.
...
#### C — Interior kitchen / entry rain vibe (when indoors)
...
The house permanently follows the world's compass system.
...
Rear garden leading toward the coconut grove and agricultural land.
...
```text
              ...
              Front Garden (+ kitchen veg beds)
                     ...
                     Front Thinnai
                            │
                  Main Wooden Entrance
                            │
────────────────────────────────────────────────

                    Open Courtyard

      Bedroom                     Small Passage
...
This layout forms the permanent backbone of the property.
...
Only traditional materials should appear.
...
The house uses traditional wooden doors.
...
Doors should remain open during most daytime scenes unless privacy or weather requires otherwise.

---

# Windows

Large wooden windows are an important feature of the house.
...
* Cross ventilation.
* Soft natural light.
* Views toward gardens.
* Cotton curtains where appropriate.

Windows connect the family with nature.

---

# Relationship Between Spaces

The house should always feel logically connected.
...
* Front Garden receives first sunlight.
* Family begins the day.
...
* Family gathers on the Front Thinnai.
* Lamps are lit.
* Dinner preparation.
* Quiet conversations.
...
* Calm.
* Soft oil-lamp lighting.
* Cricket sounds.
* Gentle breeze.

The house should visibly change with the time of day.
...
* Sunlight entering eastern windows.
* Birds.
* Dew.
* Fresh air.
...
* Warm shaded interiors.
* Gentle airflow.
* Soft shadows.

Evening

* Golden light entering western rear spaces.
...
Nature should always feel connected to the house.
...
The house should sound comforting and alive.

---

# Story Opportunities

The Family House naturally supports stories involving:
...
* Children's play.
* Quiet conversations.
* Traditional skills passed between generations.

Nearly every emotional storyline can begin or end here.

---

# Relationship With Other Documents

This document defines the **overall property**.

Detailed information belongs in individual files:
...
* Water_Well.md
* Vegetable_Garden.md
* Cow_And_Goat_Shed.md

Those documents expand each location without changing the master layout.
...
* Alter the property's orientation.

---

# Canon Authority

This document is the master architectural reference for the Family House.

All future stories, storyboards, image prompts, animations, and environmental designs involving the house must follow this layout unless a permanent canonical change is intentionally introduced.

---

# Guiding Principle

The Family House is more than a building.

It is a place where memories accumulate.

Every doorway, every window, every worn floor tile, and every shaded corner should quietly remind viewers that generations have lived here before, and that every new story becomes part of the home's continuing history.
