# Episode Brief — ep_004

| Field | Value |
| --- | --- |
| Episode ID | `ep_004` |
| Working title | **The Jackfruit That Almost Fell** |
| Format | **YouTube Short · 9:16 · ~85–95 s (finish by ~1:30)** |
| Pace | Viral **cut-cut** — micro-beats, no film padding |
...
Mother (braid + mallipoo) · Father · Elder Brother · Younger Daughter · Family Dog  
**Closing:** three close neighbours (N-02, N-03, N-04)
...
## Clip budget (cut-cut Short)

**~18–24 Flow clips** → edit to **~85–95 s** (many selects 0.7–2.0 s).  
Env = **peek only** (lake/hills/shelter in background), not separate film reels.
