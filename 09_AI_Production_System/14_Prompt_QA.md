...
- The visual style follows the official Studio Ghibli-inspired digital anime
  aesthetic for the entire frame (`Art_Style.md`), matching
  `Father_Canon_Design_Reference.png` / `Mother_Canon_Design_Reference.png`.
  Do not name or imitate any other external studio, artist, film, or franchise.
