...
| Front Garden | `Front_Garden_Canon_Design_Reference.png` | `02_World/Locations/Front_Garden.md` | **approved** (M01 · 2026-07-17) |
| Backyard | `Backyard_Canon_Design_Reference.png` | `02_World/Locations/Backyard.md` | **approved** (ep_002 sh_F08 · 2026-07-16) |
| Water Well / Well Utility Area | `Water_Well_Canon_Design_Reference.png` | `02_World/Locations/Water_Well.md` | **approved** (M03a · 2026-07-17) |
...
| Livestock Shelter — Goat Pen | `Livestock_Shelter_Goat_Pen_Canon_Design_Reference.png` | `02_World/Locations/Livestock_Shelter.md` | **approved** (M05 · 2026-07-17) |
...
| Family House establishing (wide · thinnai) | `Family_House_Establishing_Canon_Design_Reference.png` | `Front_Thinnai.md` · `Front_Garden.md` | **approved** (M01 · 2026-07-17) |
...
| Family House exterior establishing | `Family_House.md` | **approved** via `Family_House_Establishing_Canon_Design_Reference.png` |
